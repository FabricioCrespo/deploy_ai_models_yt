...
## Implentation using Jenkins Docker image:

`docker pull jenkins/jenkins`

## New files:

-  `Dockerfile`: File used to create a new Docker image from Jenkins docker image but now with pre-installed Anaconda.

- `used_commands.txt`: List of commands used to get the solution with docker.

## Modified files:

- `test_utility`: Completing function to split the dataset.

- `Jenkinsfile`: Completing the file to run the python script using the desired conda env.

## Results

- pytest in a local conda env sucessfull execution (not yet in docker):

<img src="images_rd/1.png" alt="Imagen 1" width="300">

- Jenkins pipline creation using a Git repo:

<img src="images_rd/2.png" alt="Imagen 2" width="300">

- mliplap pipline ready to be used:

<img src="images_rd/3.png" alt="Imagen 2" width="300">

- Sucessfull mliplab6 pipline execution: Same result as in local execution.

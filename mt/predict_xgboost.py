...
def main():
    ...
    MODEL_PATH = './model_xgb/xgboost_recommender.model'
    ENCODER_PATH = './data_processed/user_encoder.pkl'
    MOVIES_PATH = './movie.csv'
    PROCESSED_MOVIES_PATH = './data_processed/movies_processed.csv'
    RATINGS_PATH = './data_processed/ratings_processed.csv'

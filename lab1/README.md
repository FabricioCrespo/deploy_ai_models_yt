...
- `analyze.py`: Python script with new functionality to use SPACE OCR (provider) AI in order to upload and image and get a text.

New files:

- `make_get.py`: Python script to let a user make a get request with an url for an image to get text.
...
- Python script to make requests:

<img src="images_rd/2.png" alt="Imagen 2" width="300">

- KResult after make a request to the API:
